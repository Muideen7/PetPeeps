      ...
      >
        <div className="container mx-auto px-6 h-20 flex items-center justify-between relative">
          ...
          <div className="flex items-center gap-4">
            <button className="bg-black text-white px-6 md:px-8 py-3.5 md:py-4 rounded-full text-xs md:text-sm font-black hover:bg-gray-800 transition-all active:scale-95 shadow-lg shadow-black/10">
          ...
          >
            <div className="flex items-center justify-between mb-16">
              ...
              <button 
                ...
                className="p-3 bg-slate-50 rounded-full text-black hover:bg-slate-100 transition-colors"
              >
              ...
              {navItems.map((item, idx) => (
                ...
                >
                  <Link
                    href={`#${item.toLowerCase().replace(' ', '-')}`}
                    onClick={(e) => scrollToSection(e, item)}
                    className="text-[3.2rem] md:text-[4.5rem] font-black text-black leading-tight hover:text-[#1E75FF] transition-colors"
                  >
                    {item}
                  </Link>
                </motion.div>
            ...
            <div className="mt-12 md:mt-auto pt-12">
              ...
              >
                ...
                <p className="text-black font-black text-2xl mb-4 leading-tight">Professional pet <br/> care at your door</p>
                <p className="text-gray-500 font-bold text-lg leading-relaxed mb-8">
                  Available 24/7 for you and your beloved furry friends.
                </p>
                <Link 
                  href="/contact"
                  className="inline-flex bg-black text-white px-10 py-5 rounded-full font-black text-lg shadow-xl shadow-black/10 active:scale-95 transition-all"
                >
                  Contact Support
                </Link>
              </motion.div>
