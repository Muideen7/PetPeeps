      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row justify-between gap-16 mb-16">
          ...
          <div className="w-full lg:max-w-[450px]">
            <Link
              href="/"
              className="text-[2.6rem] font-extrabold tracking-tight text-black mb-6 inline-block leading-none cursor-pointer"
            >
              PetPeeps.
            </Link>
            <p className="text-gray-500 font-medium text-lg leading-relaxed mb-10">
              Skip the stress of take care of your pets whether it&apos;s a
              checkup, bath, or wellness visit, we make pet care easy and
              comforting right from home.
            </p>

            <div className="mb-12">
              <h4 className="font-extrabold text-black mb-6 text-lg">
          ...
          <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-12 lg:pl-12">
            {footerLinks.map((column) => (
              <div key={column.title}>
                <h4 className="font-extrabold text-black mb-8 text-lg">
                  {column.title}
                </h4>
                <ul className="space-y-4">
                  {column.links.map((link) => (
                    <li key={link.name}>
                      <Link
                        href={link.href}
                        className="text-gray-900/60 font-semibold hover:text-black transition-colors text-base whitespace-nowrap cursor-pointer"
                      >
                        {link.name}
                      </Link>
                    </li>
